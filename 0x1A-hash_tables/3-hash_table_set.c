...
/**
 * hash_node_create - it Creates a hash node (node of a linked list)
 * in the hash table
 * @key: The string key is to generate the hash value
 * @value: Value to be stored in the in the hash node
 *
 * Return: Return hash node
 */
...
/**
 * hash_table_set - This Initializes and sets the hash table
 * @ht: A pointer pointing to the hash table
 * @key: String key to generate the hash value
